				...
				<div class="row">
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="/template/images/product-detail-01.jpg">
										<div class="wrap-pic-w pos-relative">
											<img id="productThumb" src="" alt="IMG-PRODUCT">
					...
					<div class="col-md-6 col-lg-5 p-b-30">
						<div class="p-r-50 p-t-5 p-lr-0-lg">
							<h4 id="productNameShow" class="mtext-105 cl2 js-name-detail p-b-14">
								Lightweight Jacket
							</h4>
	
							<span id="productPriceShow" class="mtext-106 cl2">
								$58.79
							</span>
	
							<p id="productDesShow" class="stext-102 cl3 p-t-23">
								...
								<div class="flex-w flex-r-m p-b-10">
									<form action="/add-cart" method="post">
										<div class="size-204 flex-w flex-m respon6-next">
											...
											<input type="hidden" id="productIdShow" name="product_id" value="">
